    ...
    const myTech = (
        ...
        <div className="grid grid-cols-4 grid-rows-4 w-full h-full gap-2">
            {technologies.map((tech) => (
                <figure key={tech.name} className="hoverContainer border bg-blue border-black rounded-lg relative" onPointerEnter={() => setHovering(true)} onPointerLeave={() => setHovering(false)}>                 
